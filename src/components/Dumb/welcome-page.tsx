...
const styles = {
  centerPanel: "relative flex flex-col gap-y-[2vh] h-screen w-1/3 items-center justify-center mx-auto shadow-lg shadow-stone-500 bg-gray-300 dark:shadow-stone-950 dark:bg-gray-800 min-h-[150px]",
